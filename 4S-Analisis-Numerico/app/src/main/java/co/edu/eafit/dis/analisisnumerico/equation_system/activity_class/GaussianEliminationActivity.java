...
import co.edu.eafit.dis.analisisnumerico.equation_system.method_class.RegressiveSubstitution;
...
public class GaussianEliminationActivity extends AppCompatActivity {

    private EditText nText;
    private TableLayout tableVectorB,tableMatrixA,table,tableFinalResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tableFinalResult = (TableLayout) findViewById(R.id.tableFinalResult);
        try {
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(GaussianEliminationActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getMatrixData();
            BigDecimal [][]resA= GaussianElimination.gaussianElimination(DataUtil.matrixA,DataUtil.matrixA.length);
            BigDecimal []resB= RegressiveSubstitution.regressiveSubstitution(resA,DataUtil.vectorB,DataUtil.vectorB.length);
            createViewResult(resB,resB.length);
        }catch (Exception e){
            Toast.makeText(GaussianEliminationActivity.this,"Error, please check " +
                    "the data",Toast.LENGTH_LONG).show();
        }
    ...
    public void createViewResult(BigDecimal []result,int n){
        table.removeAllViews();
        table.addView(tableRow1);
        for(int i=0;i<GaussianElimination.tableArray.size()-1;i++){
            tableRow = new TableRow(this);
            for(int j=0;j<GaussianElimination.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(GaussianElimination.tableArray.get(i).get(j));
                tableRow.addView(textView);
            }
            table.addView(tableRow);
        }
        tableFinalResult.removeAllViews();
        tableRow = new TableRow(this);
        textView= new TextView(this);
        textView.setText("x");
        ...
        textView.setTextSize(13);
        tableRow.addView(textView);
        tableFinalResult.addView(tableRow);
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.gaussianEliminationHelp)
                ...
                .setNeutralButton(R.string.partial, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            Toast.makeText(GaussianEliminationActivity.this,
