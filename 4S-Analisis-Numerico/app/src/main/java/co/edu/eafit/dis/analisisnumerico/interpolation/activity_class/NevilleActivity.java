...
import co.edu.eafit.dis.analisisnumerico.interpolation.method_class.Neville;
import co.edu.eafit.dis.analisisnumerico.utility_class.DataUtil;

public class NevilleActivity extends AppCompatActivity {

    private EditText nText,yText;
    private TableLayout tableFuncF,tableVectorX,table,tableFinalResult;
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(NevilleActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getVectorsData();
            BigDecimal result = Neville.neville(DataUtil.funcFInterpolation,
    ...
    public void createViewResult(BigDecimal result){
        ...
        for(int i = 0; i< Neville.tableArray.size()-1; i++){
            tableRow = new TableRow(this);
            for(int j=0;j<Neville.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(Neville.tableArray.get(i).get(j));
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.neville_Help)
