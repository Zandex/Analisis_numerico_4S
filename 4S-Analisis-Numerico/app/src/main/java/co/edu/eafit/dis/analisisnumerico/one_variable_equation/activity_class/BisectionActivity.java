...
import co.edu.eafit.dis.analisisnumerico.one_variable_equation.method_class.BisectionMethod;
...
public class BisectionActivity extends AppCompatActivity {
    ...
    public void onCalculateClick(View view) {
        try {
            ...
            BisectionMethod.tableArray.clear();
            getDataHashMap();

            resultText.setText(BisectionMethod.bisection(data[0], Integer.parseInt(data[1]),
    ...
    public void createTableWithData(){
        try {
            for (int i = 0; i < BisectionMethod.tableArray.size(); i++) {
                ...
                nVal.setText(BisectionMethod.tableArray.get(i).get(0));
                xiVal.setText(BisectionMethod.tableArray.get(i).get(1));
                xsVal.setText(BisectionMethod.tableArray.get(i).get(2));
                xmVal.setText(BisectionMethod.tableArray.get(i).get(3));
                ymVal.setText(BisectionMethod.tableArray.get(i).get(4));
                errVal.setText(BisectionMethod.tableArray.get(i).get(5));
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.bisectionHelp)
