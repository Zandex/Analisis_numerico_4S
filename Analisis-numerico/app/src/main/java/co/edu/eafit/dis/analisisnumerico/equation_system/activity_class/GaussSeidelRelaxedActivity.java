...
import co.edu.eafit.dis.analisisnumerico.equation_system.method_class.GaussSeidelRelaxed;
...
public class GaussSeidelRelaxedActivity extends AppCompatActivity {

    private EditText nText,tolText,iterText,lambdaText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gauss_seidel_relaxed);
        ...
        lambdaText = (EditText)findViewById(R.id.lambdaText);
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(GaussSeidelRelaxedActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getMatrixData();
            GaussSeidelRelaxed.gaussSeidelRelaxed(DataUtil.matrixA,DataUtil.vectorX
                    ,DataUtil.vectorB,
                    ...
                    new BigDecimal(DataUtil.equationSystemDataMap.get("Lambda")),
    ...
    public void createViewResult() {
        ...
        for(int i=0;i<GaussSeidelRelaxed.tableArray.size()-1;i++){
            tableRow = new TableRow(this);
            for(int j=0;j<GaussSeidelRelaxed.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(GaussSeidelRelaxed.tableArray.get(i).get(j));
    ...
    public void setMatrix_VectorData()throws Exception{
        ...
        lambdaText.setText(DataUtil.equationSystemDataMap.get("Lambda"));
    ...
    public void getMatrixData()throws Exception{
        ...
        DataUtil.equationSystemDataMap.put("Lambda",lambdaText.getText().toString());
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.relaxedGeneralHelp)
                ...
                .setNeutralButton(R.string.partial, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            Toast.makeText(GaussSeidelRelaxedActivity.this,
