...
import co.edu.eafit.dis.analisisnumerico.equation_system.method_class.Jacobi;
...
public class JacobiActivity extends AppCompatActivity {
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(JacobiActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getMatrixData();
            Jacobi.jacobi(DataUtil.matrixA,DataUtil.vectorX
                    ,DataUtil.vectorB,
    ...
    public void createViewResult() {
        ...
        for(int i=0;i<Jacobi.tableArray.size()-1;i++){
            tableRow = new TableRow(this);
            for(int j=0;j<Jacobi.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(Jacobi.tableArray.get(i).get(j));
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.jacobiHelp)
                ...
                .setNeutralButton(R.string.partial, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            Toast.makeText(JacobiActivity.this,
