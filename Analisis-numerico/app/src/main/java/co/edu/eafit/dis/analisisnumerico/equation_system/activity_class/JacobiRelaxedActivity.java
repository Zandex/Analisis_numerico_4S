...
import co.edu.eafit.dis.analisisnumerico.equation_system.method_class.JacobiRelaxed;
...
public class JacobiRelaxedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_jacobi_relaxed);
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(JacobiRelaxedActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getMatrixData();
            JacobiRelaxed.jacobiRelaxed(DataUtil.matrixA,DataUtil.vectorX
                    ,DataUtil.vectorB,
    ...
    public void createViewResult() {
        ...
        for(int i=0;i<JacobiRelaxed.tableArray.size()-1;i++){
            tableRow = new TableRow(this);
            for(int j=0;j<JacobiRelaxed.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(JacobiRelaxed.tableArray.get(i).get(j));
                ...
                .setNeutralButton(R.string.partial, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        try {
                            ...
                            Toast.makeText(JacobiRelaxedActivity.this,
