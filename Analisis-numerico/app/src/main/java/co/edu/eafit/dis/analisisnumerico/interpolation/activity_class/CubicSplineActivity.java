...
import co.edu.eafit.dis.analisisnumerico.interpolation.method_class.CubicSpline;
import co.edu.eafit.dis.analisisnumerico.utility_class.DataUtil;

public class CubicSplineActivity extends AppCompatActivity {
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(CubicSplineActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getVectorsData();
            BigDecimal result = CubicSpline.cubicSpline(DataUtil.funcFInterpolation,
    ...
    public void createViewResult(BigDecimal result){
        ...
        for(int i = 0; i< CubicSpline.tableArray.size()-1; i++){
            tableRow = new TableRow(this);
            for(int j=0;j<CubicSpline.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(CubicSpline.tableArray.get(i).get(j));
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.cubic_Help)
