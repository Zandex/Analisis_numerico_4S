...
import co.edu.eafit.dis.analisisnumerico.interpolation.method_class.Lagrange;
...
public class LagrangeActivity extends AppCompatActivity {
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(LagrangeActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getVectorsData();
            BigDecimal result = Lagrange.lagrange(DataUtil.funcFInterpolation,
    ...
    public void createViewResult(BigDecimal result){
        ...
        for(int i = 0; i< Lagrange.tableArray.size()-1; i++){
            tableRow = new TableRow(this);
            for(int j=0;j<Lagrange.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(Lagrange.tableArray.get(i).get(j));
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.lagrange_Help)
