...
import co.edu.eafit.dis.analisisnumerico.interpolation.method_class.QuadraticSpline;
import co.edu.eafit.dis.analisisnumerico.utility_class.DataUtil;

public class QuadraticSplineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quadratic_spline);
    ...
    public void onCreateClick(View view){
        try {
            ...
            Toast.makeText(QuadraticSplineActivity.this,"Error, please check " +
    ...
    public void onCalculateClick(View view){
        try {
            getVectorsData();
            BigDecimal result = QuadraticSpline.quadraticSpline(DataUtil.funcFInterpolation,
    ...
    public void createViewResult(BigDecimal result){
        ...
        for(int i = 0; i< QuadraticSpline.tableArray.size()-1; i++){
            tableRow = new TableRow(this);
            for(int j=0;j<QuadraticSpline.tableArray.get(j).size();j++){
                textView = new TextView(this);
                textView.setPadding(5,5,8,5);
                textView.setGravity(Gravity.START);
                textView.setTextSize(15);
                textView.setText(QuadraticSpline.tableArray.get(i).get(j));
    ...
    public void onHelpClick(View view){
        ...
        builder.setMessage(R.string.quadratic_Help)
